...
const UserProfil = ({ top = true }) => {
  ...
  return (
    <>
        ...
        <div className="content-padding">
          <div className="p-r-content">
            ...
            <div className="profil-info">
              ...
              <Accordion
                expanded={expanded === "annonces"}
                onChange={handleChange("annonces")}
                className="accordion"
              >
                <AccordionSummary expandIcon={<IonIosArrowDown />}>
                  Les annonces
      ...
      {!top && (
        <div className="user-profil-act-button">
          <div>
            <button>Invalider le profil</button>
